...
<head>
    ...
    <link rel="stylesheet" href="/Tov_no/viewTov_style.css" />
</head>
<body>
<?php
        ...
        if(!empty($query))   {
                        ...
                        { 
                            while ($row = mysqli_fetch_assoc($result)) 
                            {
                                    ...
                                    <li><form action="/Tov_no/Add_Kor.php" method="GET"> <input  type="hidden"  name="add" value=<?php echo $row['Id_tov'] ?>><button class="button" type="submit">В корзину</button></form>
                                </ul> 
                            <?php
                            }                
                        }
